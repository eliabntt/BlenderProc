...
listed.sort()
found = False
tobefound = "00004f89-9aa5-43c2-ae3c-129586be8aaa" ## this is the first one
whitelist = []
...
for i in listed:
    ...
    try:
        ...
        evaluation_mode='VIEWPORT',default_prim_path="/world",root_prim_path="/world",material_prim_path="/world/materials",
        ...
        for obj in bpy.data.objects:
            if obj.type != 'LIGHT':
                for v in obj.data.vertices:
                    ...
                    if "wall" in obj.name.lower() or "floor" in obj.name.lower():
                        pts.append([l[0],l[1]])
                        if l[0] < mx: mx = l[0]
                        if l[0] > MX: MX = l[0]
                        if l[1] < my: my = l[1]
